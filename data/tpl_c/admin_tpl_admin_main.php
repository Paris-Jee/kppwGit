<?php keke_tpl_class::checkrefresh('admin/tpl/admin_main', '1449998962' );?><!DOCTYPE HTML>
...
<div class="box">
    ...
    <div class="detail pad10">
        <ul>
            <li>
               <?php echo $_lang['version_number'];?> :	<?php echo P_NAME;?><?php echo KEKE_VERSION;?> <?php echo KEKE_LASTTIME;?>
            </li>
            <li>
