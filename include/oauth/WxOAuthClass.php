...
class WxOAuthClass extends OAuthBase {
	const OAUTH_AUTHORIZE_URL = 'https://open.weixin.qq.com/connect/qrconnect';//请求用户授权Token 
	const OAUTH_ACCESS_TOKEN_URL = 'https://api.weixin.qq.com/sns/oauth2/access_token';//获取授权过的Access Token 
	const OAUTH_API_URL = 'https://api.weixin.qq.com/sns/userinfo';//授权信息查询接口 
